...
local SilentAimSettings = {
    ...
    ClassName = "Vinchell aimbot - Averiias, Stefanuk12, xaxa",
    ToggleKey = "RightAlt",
...
local MainFileName = "Vinchell aimbot"
...
local Files = listfiles(string.format("%s/%s", "Vinchell", tostring(game.PlaceId)))
...
local Window = Library:CreateWindow("Vinchellx hub , Aimbot script")
